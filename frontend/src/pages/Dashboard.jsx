    ...
    <div className="max-w-7xl mx-auto space-y-8">
      ...
      <div className="grid md:grid-cols-4 gap-6 mb-8">
        <div className="bg-white rounded-lg shadow-md p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-gray-600">Elements Studied</p>
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-gray-600">Favorite Elements</p>
              <p className="text-2xl font-bold text-gray-900">0</p>
            </div>
          </div>
        </div>
      ...
      <div className="bg-white rounded-lg shadow-md p-6 mt-8">
        ...
        <div className="text-center py-8">
          ...
          <p className="text-gray-500">No recent activity. Start exploring elements to see your progress here!</p>
        </div>
      </div>
    </div>
  )
